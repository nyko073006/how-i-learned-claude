...
> Stand der globalen `~/.claude/CLAUDE.md` vor dem Umbau am 2026-09-24. Grund des Umbaus: siehe [[Changelog]].
...
>
> `${VAULT}` = Pfad zu deinem Obsidian-Vault (z.B. `/Users/nyko/Documents/Claude-Projekte/SecondBrain/`)
...
- Vault-Pfad: `${VAULT}` (z.B. `/Users/nyko/Documents/Claude-Projekte/SecondBrain/`)
